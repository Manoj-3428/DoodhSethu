    ...
    private suspend fun syncToFirestore(dailyCollection: DailyMilkCollection) = withContext(Dispatchers.IO) {
        try {
            ...
            val firestoreData = DailyMilkCollectionFirestore(
                ...
                am_milk = kotlin.math.round(dailyCollection.amMilk * 10000.0) / 10000.0,
                am_fat = kotlin.math.round(dailyCollection.amFat * 10000.0) / 10000.0,
                am_price = kotlin.math.round(dailyCollection.amPrice * 10000.0) / 10000.0,
                pm_milk = kotlin.math.round(dailyCollection.pmMilk * 10000.0) / 10000.0,
                pm_fat = kotlin.math.round(dailyCollection.pmFat * 10000.0) / 10000.0,
                pm_price = kotlin.math.round(dailyCollection.pmPrice * 10000.0) / 10000.0,
                total_milk = kotlin.math.round(dailyCollection.totalMilk * 10000.0) / 10000.0,
                total_fat = kotlin.math.round(dailyCollection.totalFat * 10000.0) / 10000.0,
                total_amount = kotlin.math.round(dailyCollection.totalAmount * 10000.0) / 10000.0,
